# Generated by Powerlevel10k configuration wizard on 2022-05-29 at 14:14 KST.
...
() {
	...
	function prompt_device_name() {
		p10k segment -b 2 -f '219' -t "%B$USER"
	}
	...
	typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='%F{213}]'
	# MODED '▓▒░'
	...
	typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%F{213}['
	...
	typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=219
	# Custom icon.
	typeset -g POWERLEVEL9K_BACKGROUND_JOBS_VISUAL_IDENTIFIER_EXPANSION='神'
